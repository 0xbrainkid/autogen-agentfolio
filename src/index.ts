/**
 * autogen-agentfolio — AgentFolio integration for AutoGen
 *
 * Give Microsoft AutoGen agents access to AgentFolio agent identity, trust scores, and marketplace.
 *
 * Provides:
...
/**
 * Tool definitions for AutoGen integration.
...
/**
 * Create a configured AgentFolio toolkit for AutoGen.
